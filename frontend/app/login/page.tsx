  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-1 flex">
        {/* Left side - Branding */}
        <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 flex-col justify-between text-white">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-white/80 max-w-md">
              Never lose track of where you applied. Our browser extension automatically
              saves jobs as you browse, and our dashboard gives you complete visibility
